...
#SBATCH -p cluster
#SBATCH --exclusive
#SBATCH -o "%j-bcast-Cosmos-CXI-tests.txt"
#SBATCH -J "CXI test"
...
topdir=$HOME/HWAccel-OFI
TESTDIR=$topdir/Ben-libfabric/prov/cxi/test/multinode
MPIDIR=$topdir/mvapich-plus
OFIDIR=$topdir/Ben-libfabric/
